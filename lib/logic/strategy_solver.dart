...
import 'strategy/naked_triple_strategy.dart';
import 'strategy/hidden_quad_strategy.dart';
...
class StrategySolver {
  ...
  /// Find naked triples in the board - delegates to NakedTripleStrategy
  StrategyResult? findNakedTriple() {
    return NakedTripleStrategy().find(board, candidates);
  }
  ...
  /// Find hidden quads in the board - delegates to HiddenQuadStrategy
  StrategyResult? findHiddenQuad() {
    return HiddenQuadStrategy().find(board, candidates);
  }
}
